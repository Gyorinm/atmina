...
class _AtminaAppState extends State<AtminaApp> {
  ...
  void _openLink(Uri uri) {
    ...
    try {
      ...
      _navigatorKey.currentState?.push(MaterialPageRoute(builder: (_) => OrderLinkScreen(payload: payload)));
    } catch (_) {}
  }
  @override Widget build(BuildContext context) => MaterialApp(
    navigatorKey: _navigatorKey, debugShowCheckedModeBanner: false, title: 'Atmina POS', theme: AppTheme.lightTheme,
